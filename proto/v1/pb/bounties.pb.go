...
type BountyTransfer struct {
	...
	Transfer    *EosTransfer `protobuf:"bytes,2,opt,name=transfer,proto3" json:"transfer,omitempty"`
}
...
func (x *BountyTransfer) GetTransfer() *EosTransfer {
	if x != nil {
		return x.Transfer
	}
	return nil
...
var file_bounties_proto_rawDesc = []byte{
	...
	,
...
var file_bounties_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_bounties_proto_goTypes = []interface{}{
	(*BountyTransfer)(nil), // 0: eosn.protobuf.v1.BountyTransfer
	(*Transaction)(nil),    // 1: eosn.protobuf.v1.Transaction
	(*EosTransfer)(nil),    // 2: eosn.protobuf.v1.EosTransfer
	(*emptypb.Empty)(nil),  // 3: google.protobuf.Empty
}
var file_bounties_proto_depIdxs = []int32{
	1, // 0: eosn.protobuf.v1.BountyTransfer.transaction:type_name -> eosn.protobuf.v1.Transaction
	2, // 1: eosn.protobuf.v1.BountyTransfer.transfer:type_name -> eosn.protobuf.v1.EosTransfer
	0, // 2: eosn.protobuf.v1.PomeloBountiesInternalService.AddBountyTransfer:input_type -> eosn.protobuf.v1.BountyTransfer
	3, // 3: eosn.protobuf.v1.PomeloBountiesInternalService.AddBountyTransfer:output_type -> google.protobuf.Empty
